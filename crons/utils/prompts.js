...
const createNewsResumePrompt = (title, tags, url, content, lang) => {
  return `Title: ${title}
    ...
    Instructions:
    Create a factual and concise summary of the article in ${lang}. The summary must:
    ...
    2. Include only essential information:
       ...
       - What are the solutions/recommendations (if applicable)?
    3. Use short and direct sentences
    4. Avoid marketing language or verbose phrasing
    5. ${lang === 'english' ? '' : 'Keep technical terms in English'}
    6. Do not use markdown formatting
    7. Must feel like a human wrote it, not an artificial intelligence
    8. Finish with the article url: ${url}
    9. The summary should be informative, not a simple list of sentences that give the impression of reading text generated by artificial intelligence
`;
};
